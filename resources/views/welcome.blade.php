...
@vite('resources/css/Css_BienestarMind/style.css')
</head>
<body>
<header>
...
<div class="slider">
  <div class="slides">
    <img src="{{ asset('images/sena_inspira.jpeg') }}" alt="SENA Inspira">
    <img src="{{ asset('images/animo_comunidadsena.jpeg') }}" alt="Ánimo Comunidad SENA">
    <img src="{{ asset('images/fortalece_trabajoenequipo.jpeg') }}" alt="Fortalece Trabajo en Equipo">
    <img src="{{ asset('images/trazabilidad_sena.jpeg') }}" alt="Trazabilidad SENA">
    <img src="{{ asset('images/sostenimiento_sena.jpg') }}" alt="sostenimiento">
    <img src="{{ asset('images/ofercta_presencial2.jpg') }}" alt="ofertapresencial2">
    <img src="{{ asset('images/feria_institucional.jpg') }}" alt="feria_institucional">
    <img src="{{ asset('images/sena_marcha.jpeg') }}" alt="marcha">
  </div>
</div>

  <div class="logo-bienestarmind-container">
<img src="{{ asset('/images/LOGO_BIENESTARMIND04.png') }}" alt="BienestarMind Logo">
</div>
